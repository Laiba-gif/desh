...
app.layout = html.Div([
    ...
    dcc.Dropdown(
        ...
        {'label': 'Recession Period Statistics', 'value': 'Recession Period Statistics'}
         ...
         placeholder='Select a report type',  # Set the placeholder text
...
@app.callback(
    Output(component_id='select year', component_property='select year'),
...
# Define the callback function to update the input container based o‹n the selected statistics
@app.callback(
...
# TASK 2.6: C  reate and display graphs for Yearly Report Statistics
